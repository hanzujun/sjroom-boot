package com.github.sjroom.common.beans;

import com.github.sjroom.common.utils.BeanUtil;
import com.github.sjroom.common.utils.ClassUtil;
import com.github.sjroom.common.utils.ReflectUtil;
import com.github.sjroom.common.utils.StringUtil;
...
public abstract class AbstractBeanCopier {
    ...
    private static final Type CLASS_UTIL = TypeUtils.parseType(ClassUtil.class.getName());
     ...
     */
    private static final ConcurrentMap<BeanCopierKey, AbstractBeanCopier> BEAN_COPIER_MAP = new ConcurrentHashMap<>(32);
