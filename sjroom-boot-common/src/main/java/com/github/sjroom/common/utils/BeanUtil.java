...
import com.github.sjroom.common.beans.AbstractBeanCopier;
import com.github.sjroom.common.beans.BeanCopyConverter;
...
public class BeanUtil extends org.springframework.beans.BeanUtils {
    ...
    public static <T> T newInstance(String clazzStr) {
        ...
        try {
            Class<?> clazz = ClassUtil.forName(clazzStr, classLoader);
